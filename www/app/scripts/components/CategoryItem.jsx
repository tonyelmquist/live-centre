...
const imagePathPrefix =
  'http://ec2-35-158-87-9.eu-central-1.compute.amazonaws.com/images/';
...
class CategoryItem extends Component {
    _handlePlay = (videoUrl) => {
        ...
        this.props.dispatch(
      videoSelected(
        `http://ec2-35-158-87-9.eu-central-1.compute.amazonaws.com/video-files/${videoUrl}`,
      ),
    );
    };
    ...
    render() {
        return (
          ...
          // subtitle={< span > by < b > {this.props.video.author} </b></span >}
              ...
              actionIcon={
                <div>
                  ...
                  <IconButton
                    ...
                    style={styles.medium}
                    onTouchTap={() => {
                        this._handlePlay(this.props.video.video_url);
                    }}
                  >
            ...
            >
              <img alt={this.props.video.title} src={`${imagePathPrefix + this.props.video.thumbnail}`} />
            </GridTile>
          </div>
        );
    }
