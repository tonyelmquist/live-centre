...
class BurstButton extends React.Component {
    constructor(props) {
        ...
        this.viewportSize =
      this.state.size + this.circlePadding + this.smallCircleSize;
        ...
        return (
          <div className="burst-button-container" style={this.props.style}>
            ...
            >
              ...
              <g
                className={`burst-large-circle ${this.state.isOpen ? 'open' : ''}`}
              ...
              {/* Top Left Circle */}
              <g
                className={`burst-small-circle ${this.state.isOpen
              ? 'open'
              : ''} ${this.state.activeButton === 'top left' ? 'active' : ''}`}
              >
                <circle
                  cx={this.smallTopLeft.x}
                  cy={this.smallTopLeft.y}
                  r={this.smallCircleSize / 2}
                  fill={this.state.color}
                />
                <text fill="white" x={this.smallTopLeft.x} y={this.smallTopLeft.y}>
              &#xf040;
            </text>
              </g>
              ...
              <g
                className={`burst-small-circle ${this.state.isOpen
              ? 'open'
              : ''} ${this.state.activeButton === 'top right' ? 'active' : ''}`}
              >
                <circle
                  cx={this.smallTopRight.x}
                  cy={this.smallTopRight.y}
                  r={this.smallCircleSize / 2}
                  fill={this.state.color}
                />
                <text
                  fill="white"
                  x={this.smallTopRight.x}
                  y={this.smallTopRight.y}
                >
              /f040;
            </text>
              </g>
              ...
              <g
                className={`burst-small-circle ${this.state.isOpen
              ? 'open'
              : ''} ${this.state.activeButton === 'bottom left'
              ? 'active'
              : ''}`}
              >
                <circle
                  cx={this.smallBottomLeft.x}
                  cy={this.smallBottomLeft.y}
                  r={this.smallCircleSize / 2}
                  fill={this.state.color}
                />
                <text
                  fill="white"
                  x={this.smallBottomLeft.x}
                  y={this.smallBottomLeft.y}
                >
              &#xf0c0;
            </text>
              </g>
              ...
              <g
                className={`burst-small-circle ${this.state.isOpen
              ? 'open'
              : ''} ${this.state.activeButton === 'bottom right'
              ? 'active'
              : ''}`}
              >
                <circle
                  cx={this.smallBottomRight.x}
                  cy={this.smallBottomRight.y}
                  r={this.smallCircleSize / 2}
                  fill={this.state.color}
                />
                <text
                  fill="white"
                  x={this.smallBottomRight.x}
                  y={this.smallBottomRight.y}
                >
              &#xf040;
            </text>
              </g>
