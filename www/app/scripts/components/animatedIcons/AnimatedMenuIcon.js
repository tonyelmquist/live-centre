...
const rgbaColor="rgba(0,0,0,0.7)";
	...
	return(
		<svg className={(isMenuOpen()? "animMenuIcon open " : "animMenuIcon closed ") + (isSubPage? "animMenuIcon subPage " : "animMenuIcon superPage ")}  height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
