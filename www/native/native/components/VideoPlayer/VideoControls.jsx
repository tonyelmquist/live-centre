...
import { showReplay, hideReplay, showHighlights, setControlBarVisibility,
    isVideoSettingsOpen, showProductOverlay, showProductThumb,
     updateCurrentTime, changeCurrentTime, skipCurrentTimeBy, setDuration, playVideo, pauseVideo, toggleVideoTickers, videoSelected } from '../../../../../native/shared/actions/videoPlayer';
import SettingsOverlay from '../SecondLayer/SettingsOverlay';
import {
  showSettingsOverlay,
  showAllOverlays,
} from '../../../../../native/shared/actions/overlayManager';
