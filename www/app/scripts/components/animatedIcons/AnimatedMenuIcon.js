...
const AnimatedMenuIcon = ({isMenuOpen, isSubPage}) => {
	const name = `animMenuIcon ${(isMenuOpen()? "open " : "closed ")}${(isSubPage? "subPage " : "superPage ")}`;
	return(
		<svg className={name}  height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
